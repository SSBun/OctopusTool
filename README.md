...
#### 📊 数据处理
- 时间戳转换 - Unix 时间戳与日期互转
- 正则表达式测试 - **实时高亮匹配**，支持捕获组
- 颜色转换 - HEX/RGB/HSL 互转
- 单位转换 - 常用单位换算
- 二维码/条形码 - 生成与解析，支持历史记录
...
- 密码生成器 - 安全密码生成
- UUID 生成器 - 批量生成 UUID
- AI 变量命名 - AI 智能生成专业变量名
- 查找替换 - 支持正则表达式
- 文本排序 - 多种排序方式
- Lorem Ipsum - 占位文本生成
- CSV 转换 - CSV 与 JSON 互转
- Emoji 大全 - Emoji 表情搜索和组合
- Markdown 编辑器 - 实时预览
...
#### 🗄️ 数据库工具
- SQL 格式化 - 美化和格式化 SQL
- AI SQL 生成器 - 自然语言生成 SQL
- SQL 转换工具 - MySQL/PostgreSQL 方言互转
- 表结构设计器 - 可视化建表工具
- SQL 注入检测 - 安全风险分析
- SQL 性能优化 - 索引推荐和执行计划解释
