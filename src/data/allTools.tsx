...
export const ALL_TOOLS: Tool[] = [
  ...
  },
  {
    ...
    title: 'AI 变量命名',
    description: '借助 AI 生成专业的变量名建议，支持多种命名风格',
    path: '/tools/text/variable-naming',
    status: '可用',
    category: '文本处理',
  },
  {
  ...
  // === 数据库工具 ===
  {
    ...
    path: '/tools/database/sql-formatter',
    status: '可用',
    category: '数据库工具',
  },
  {
    ...
    path: '/tools/database/ai-sql-generator',
    status: '可用',
    category: '数据库工具',
  },
  {
    ...
    path: '/tools/database/sql-converter',
    status: '可用',
    category: '数据库工具',
  },
  {
    icon: <TableChart sx={{ fontSize: 40 }} />,
    title: '表结构设计器',
    description: '可视化建表工具，生成 CREATE TABLE 语句',
    path: '/tools/database/table-designer',
    status: '可用',
    category: '数据库工具',
  },
  {
    ...
    title: 'ER 图设计器',
    description: '在线绘制实体关系图，导出 SQL DDL',
    path: '/tools/database/er-designer',
    status: '计划中',
    category: '数据库工具',
  },
  {
    ...
    title: '数据库文档生成',
    description: '根据 SQL 自动生成数据库文档',
    path: '/tools/database/doc-generator',
    status: '计划中',
    category: '数据库工具',
  },
  {
    icon: <Security sx={{ fontSize: 40 }} />,
    title: 'SQL 注入检测',
    description: '分析 SQL 安全风险，注入漏洞扫描',
    path: '/tools/database/sql-injection-checker',
    status: '可用',
    category: '数据库工具',
  },
  {
    icon: <CompareArrows sx={{ fontSize: 40 }} />,
    title: 'SQL 差异对比',
    description: '比较两个 SQL 语句或表结构差异',
    path: '/tools/database/sql-diff',
    status: '计划中',
    category: '数据库工具',
  },
  {
    icon: <SwapVert sx={{ fontSize: 40 }} />,
    title: '数据导入导出',
    description: 'CSV/JSON/Excel 与 SQL 互相转换',
    path: '/tools/database/data-import-export',
    status: '计划中',
    category: '数据库工具',
  },
  {
    ...
    title: '测试数据生成',
    description: '根据表结构生成 Mock 测试数据',
    path: '/tools/database/mock-data-generator',
    status: '计划中',
    category: '数据库工具',
  },
  {
    ...
    path: '/tools/database/sql-optimizer',
    status: '可用',
    category: '数据库工具',
  },
  {
